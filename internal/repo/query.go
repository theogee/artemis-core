...
const (
	...
	InsertStudentsQuery = `
		INSERT INTO students (given_name,surname,gender,sgu_major_id,fh_department_id,student_id,date_of_birth,city_of_birth,passport_number,date_of_issue,date_of_expiry,issuing_office,private_email,sgu_email,username,password,fh_email,iban,mobile_phone,mobile_phone_de)
		VALUES
	`
